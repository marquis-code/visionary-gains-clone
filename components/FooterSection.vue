    ...
    >
      <div class="md:flex justify-between items-center space-y-10 md:space-y-0">
        ...
        <div class="md:flex md:gap-x-10 space-y-10 md:space-y-0">
          ...
          <div class="sm:text-left">
            <p
              class="text-lg font-medium md:flex justify-center items-center md:ml-20"
            >
              Contact Us
            </p>
            ...
            <ul
              class="mt-2 space-y-4 hidden md:flex justify-end items-end flex-col"
            >
