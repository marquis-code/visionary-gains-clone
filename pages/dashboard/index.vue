    ...
    <div class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-8">
      <div class="lg:col-span-2 border-blue-500">
        <div
          ...
          data-id="4"
          data-coins="bitcoin,ethereum,bnb,usd-coin,litecoin,trust-wallet-token"
          data-numcoins="50"
        />
      </div>
      <div class="rounded-lg bg-blue-50 border">
        <div class="flex justify-between items-center px-3">
          <div class="py-2">
            <h1 class="text-gray-700 text-sm font-bold">Account Balance</h1>
            <p class="text-gray-400 text-xl">
              <span class="text-xl text-gray-900">{{
                formatNumberAsDollar(userData?.accountBalance) ?? "0.00"
              }}</span>
            </p>
          </div>
          <div>
            <nuxt-link
              ...
              class="bg-black text-white rounded-md px-3 py-2.5"
            >
              Deposit Funds
            </nuxt-link>
          </div>
        ...
        <div class="space-y-6">
          <div class="md:flex items-center gap-x-6 p-3 space-y-6 md:space-y-0">
            ...
            >
              ...
              <div class="border-t-[0.4px] border-white">
                <div class="px-3 py-2">
                  <p class="text-white text-xs">Profits</p>
          ...
          >
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td class="p-3 text-right">
                        <span
                          class="px-3 py-1 font-semibold rounded-md text-white"
                          :class="[
            ...
            <p
              v-if="!transactionsList.length && !loadingTransactions"
              class="text-center font-medium py-20"
            >
