      ...
      return [
        {
          name: "Total Profit",
          count: `${
            this.formatNumberAsDollar(this.stats?.totalProfit) ?? "N/A"
          }`,
          icon: "funds",
        ...
        },
        {
          ...
          count: `${
            this.formatNumberAsDollar(this.stats?.totalWithdrawal) ?? "N/A"
          }`,
          icon: "customers",
        ...
        },
        {
          name: "Total Deposits",
          count: `${
            this.formatNumberAsDollar(this.stats?.totalDeposits) ?? "N/A"
          }`,
          icon: "users",
